...
int MatrixMultiply(int argc, char **argv,
    ...
    struct timeval d_init_start, d_init_end;
    struct timeval d_init_minus_start, d_init_minus_end;
    ...
    gettimeofday(&d_init_start, NULL);
#endif
    checkCudaErrors(cudaMalloc(reinterpret_cast<void **>(&d_A), mem_size_A));
#ifdef  TIMING
    gettimeofday(&d_init_end, NULL);
#endif
#ifdef  TIMING
    gettimeofday(&d_init_minus_start, NULL);
#endif
    checkCudaErrors(cudaMalloc(reinterpret_cast<void **>(&d_B), mem_size_B));
#ifdef  TIMING
    gettimeofday(&d_init_minus_end, NULL);
#endif
    ...
    double init_time_minus = tvsub(d_init_minus_start, d_init_minus_end);
    double init_time_total = tvsub(d_init_start, d_init_end);
    double d_init_time = init_time_total - init_time_minus;
    double d_malloc_time    = tvsub(d_malloc_start, d_malloc_end) - d_init_time;

    printf("================\n");
    printf("context init: \t\t%f\n", d_init_time);
